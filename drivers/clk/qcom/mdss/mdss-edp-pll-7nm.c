...
static struct clk_fixed_factor edp_link_clk_divsel_ten = {
	.div = 10,
	.mult = 1,

	.hw.init = &(struct clk_init_data){
		.name = "edp_link_clk_divsel_ten",
		.parent_names =
...
static struct clk_fixed_factor dp2_link_clk_divsel_ten = {
	.div = 10,
	.mult = 1,

	.hw.init = &(struct clk_init_data){
		.name = "dp2_link_clk_divsel_ten",
		.parent_names =
...
static struct clk_regmap_mux edp_vco_divided_clk_src_mux = {
	.reg = 0x64,
	.shift = 0,
	.width = 2,
	...
	.clkr = {
		.hw.init = &(struct clk_init_data){
			.name = "edp_vco_divided_clk_src_mux",
			.parent_names =
...
static struct clk_regmap_mux dp2_vco_divided_clk_src_mux = {
	.reg = 0x64,
	.shift = 0,
	.width = 2,
	...
	.clkr = {
		.hw.init = &(struct clk_init_data){
			.name = "dp2_vco_divided_clk_src_mux",
			.parent_names =
...
static struct clk_hw *mdss_dp_pllcc_7nm
	[DP_PHY_INDEX_MAX][DP_VCO_DIVIDED_CLK_SRC_MUX + 1] = {
	{
		...
		[DP_LINK_CLK_DIVSEL_TEN] = &dp2_link_clk_divsel_ten.hw,
		...
		[DP_VCO_DIVIDED_CLK_SRC_MUX] =
				&dp2_vco_divided_clk_src_mux.clkr.hw,
	},
	{
		[DP_VCO_CLK] = &edp_vco_clk.hw,
		[DP_LINK_CLK_DIVSEL_TEN] = &edp_link_clk_divsel_ten.hw,
		...
		[DP_VCO_DIVIDED_CLK_SRC_MUX] =
				&edp_vco_divided_clk_src_mux.clkr.hw,
	},
};
				 ...
				 struct mdss_pll_resources *pll_res)
{
	...
	case DP_PHY_INDEX_DP_ONLY:
		dp2_vco_divided_clk_src_mux.clkr.regmap = regmap;
		dp2_vco_clk.priv = pll_res;
		break;
	case DP_PHY_INDEX_EDP:
		edp_vco_divided_clk_src_mux.clkr.regmap = regmap;
